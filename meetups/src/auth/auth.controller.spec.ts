...
describe('AuthController2', () => {
  ...
  describe('registration', () => {
    it('should return an array of Auth', async () => {
      ...
      try {
        const data = expect(await authController.create(mockRequest));
  ...
  describe('authorization', () => {
    it('should return an array of Auth', () => {
      const mockRequest = {
        username: 'testuser',
        password: 'testuser',
      } as AuthLoginDto;
      ...
      expect(authController.login(mockRequest, mockAuthRequest)).toMatchObject(
        result,
      );
    });
  });
